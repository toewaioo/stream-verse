            ...
            <div className="prose prose-invert prose-lg max-w-none">
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-6">
                        Welcome to Cineverse. By accessing or using our
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        By creating an account or using Cineverse, you
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        You must be at least 13 years old to use Cineverse.
                ...
                <section className="mb-12">
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                        <li>
                            <strong>Billing:</strong> Subscriptions are billed
                        ...
                        <li>
                            <strong>Refunds:</strong> No refunds for partial
                            subscription periods
                        </li>
                        <li>
                            <strong>Price Changes:</strong> We reserve the right
                            to modify pricing with advance notice
                        </li>
                        <li>
                            <strong>Payment Methods:</strong> You must provide a
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-6">
                        ...
                        license to access and view content on Cineverse for
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                        <li>
                            Download, copy, or redistribute content without
                            authorization
                        </li>
                        <li>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        are owned by or licensed to Cineverse and are protected
                ...
                <section className="mb-12">
                    ...
                    <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                        ...
                        <li>
                            Respects the rights of other users and content
                            creators
                        </li>
                        <li>
                            Does not involve harassment, abuse, or hate speech
                        </li>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        ...
                        account at any time, with or without notice, for conduct
                        that violates these Terms of Service or is harmful to
                        other users, us, or third parties, or for any other
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-6">
                        We provide the service "as is" and make no warranties
                        regarding availability, reliability, or quality. We do
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        To the fullest extent permitted by law, Cineverse shall
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        While we strive to provide accurate content information,
                        we do not guarantee the accuracy, completeness, or
                        reliability of any content descriptions, metadata, or
                        related information.
                    </p>
                </section>
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        ...
                        posting the updated terms on this page. Your continued
                        use of the service after such changes constitutes
                ...
                <section className="mb-12">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                        ...
                        jurisdiction in which Cineverse operates, without regard
