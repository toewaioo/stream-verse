                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                            ...
                            {isVip ? (
                                ...
                                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700 text-center">
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                                        Upgrade to VIP to unlock exclusive
                                        content, ad-free viewing, and higher
                                        quality streams.
                                    </p>
                                </div>
                            )}
                        ...
                        <div className="p-6">
                            ...
                            <form onSubmit={handleRedeem} className="max-w-xl">
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    VIP keys can be purchased from our official
                                    resellers or obtained through special
                                    promotions.
                                </p>
                            </form>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Enjoy your favorite movies and shows without any
                                interruptions.
                            </p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Access to VIP-only movies, series, and early
                                releases.
                            </p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                Stream in 4K Ultra HD and enjoy crystal clear
                                audio.
                            </p>
                        </div>
                    </div>
