            ...
            <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-white selection:text-black">
                ...
                <div className="pt-24 pb-12 md:pt-32 md:pb-16">
                    <div className="container mx-auto px-6 md:px-12">
                        {/* Hero Section */}
                        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-900/40 via-purple-900/40 to-black border border-white/10 p-8 md:p-12 backdrop-blur-sm">
                            <div className="absolute top-0 right-0 -mt-16 -mr-16 w-64 h-64 bg-purple-500/20 rounded-full blur-3xl"></div>
                            ...
                            <div className="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
                                ...
                                <div className="flex-1 text-center md:text-left space-y-2">
                                    ...
                                    <div className="flex flex-col md:flex-row items-center md:items-center gap-2 md:gap-4 text-gray-400">
                                    ...
                                    <div className="pt-4 flex flex-wrap justify-center md:justify-start gap-3">
                                        ...
                                        {user.email_verified_at ? (
                                            <span className="px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20 text-xs font-medium text-green-400 flex items-center gap-1">
                                            ...
                                            <span className="px-3 py-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-xs font-medium text-yellow-400">
                                                Unverified
                                            </span>
                                        )}
                                    </div>
                        ...
                        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div>
                                <div className="bg-red-500/5 border border-red-500/20 p-6 md:p-8 rounded-2xl backdrop-blur-sm">
