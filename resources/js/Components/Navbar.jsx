        ...
        <>
            ...
            >
                <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
                    {/* Logo */}
                    <Link href={route("home")} className="text-2xl font-serif font-bold tracking-tighter text-white z-50">
                    ...
                    <div className="flex items-center gap-4">
                        {/* Desktop Search */}
                        <div className={`hidden md:flex relative items-center transition-all duration-300 ${isSearchOpen ? "w-64" : "w-8"}`}>
